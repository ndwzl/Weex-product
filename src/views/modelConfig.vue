...
//                        },
                ...
                if(ProductId.result == 'success'){
                    ...
                    this.getData(this.ajaxUrl() + '/index.php?r=weex/product/config&productId=' + ProductId.data,ele => {
                        if(ele.ok){
                            ...
                            //车型询底价人数
                            this.footerInfo.askTotal = ele.data.askPriceNum;
                            //车型id
                            this.footerInfo.ProductId = ele.data.productId;

                            //对比车型信息
                            this.configData.products.push(ele.data.productInfo);
        ...
        methods:{
            ...
            goFooterPirce(proInfo){
                this.eventGa(weex.config.deviceId,'点击询底价按钮','产品库-车型配置页','询价按钮')
